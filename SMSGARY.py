...
for i in range(3):
    ...
    if(pwd==password):
     ...
     break
        ...
        print("\033[1;96mรหัสผิดน้าาาใจ้ย็นๆ\033[1;97m",i-l)
os.system("clear")
...
print("ห้ามขาย by Gary McKinnon")
...
def loop(num):
    for i in range(num):
        t.spamais(num)
        print("ส่งไปแล้ว [AISP_Play]ส่งไปแล้วนะจะ gary mcKinnon ")
loop(num)
def loop(num):
    for i in range(num):
        t.spamais(num)
        print("ส่งไปแล่ว [AISP_Play]ส่งไปแล้วนะจะ gary mcKinnon ")
loop(num)
